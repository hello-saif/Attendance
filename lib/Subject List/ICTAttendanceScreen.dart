...
class _ICTAttendanceScreenState extends State<ICTAttendanceScreen> {
  ...
  final CollectionReference studentsICTCollection = FirebaseFirestore.instance.collection('studentsICT');
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: studentsICTCollection.snapshots(),
                builder: (context, snapshot) {
                  ...
                  final List<Student> students = snapshot.data!.docs.map((doc) {
                    ...
                    final isPresent = attendance[_formattedDate(currentDate)]?['ICT']?['isPresent'] ?? false;
                          ...
                          children: [
                            Checkbox(
                              ...
                              onChanged: (bool? value) {
                                ...
                                // Update Firestore
                                studentsICTCollection.doc(students[index].id).update({
                                  'attendance.${_formattedDate(currentDate)}.ICT.isPresent': students[index].isPresent,
                                });
                              },
                            ),
                            IconButton(
                              ...
                              onPressed: () {
                                studentsICTCollection.doc(students[index].id).delete();
                              },
                            ),
                          ],
                        ),
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                if (name.isNotEmpty && imageUrl.isNotEmpty) {
                  ...
                  await studentsICTCollection.add({
                    'name': name,
                    'imageUrl': imageUrl,
                    'attendance': {
                      _formattedDate(currentDate): {'ICT': {'isPresent': false}},
                    },
                  });
                  Navigator.of(context).pop();
                }
  ...
  void _submitAttendance() {
    ...
    studentsICTCollection.get().then((QuerySnapshot querySnapshot) {
